...
<select NAME="sel1[]" class="txtPag" ID="sel1" SIZE="5" multiple="multiple" style="width: 250px">
<!--optEmp-->
</select>
</span>
</td>
...
<td>
<select NAME="sel2[]" class="txtPag" ID="sel2" SIZE="5" multiple="multiple" style="width: 250px">
</select>
<!--
...
<tr><td colspan="2" align="center"><input type="button" class="btn" value="Load monthly report" onClick="loadMonthlyReport()"/></td></tr>
</table>
<br><br><br><br>
<div id="lyData"></div>
