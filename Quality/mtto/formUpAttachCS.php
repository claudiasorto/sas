<form method="POST" name="frmCv" id="frmCv" enctype="multipart/form-data" target="frUP" action="mtto/upAttachCS.php" >
...
<tr><td height="10"></td></tr>
  ...
  <tr><td style="padding-left:5px;">    
	   <table cellpadding="0" cellspacing="0" class="tab_on" width="400">
		 ...
		 <tr><td colspan="2" align="right" style="padding-right:10px;"><input type="button" id="btnUp" class="btnSel" onclick="upFileCS();" value=" upload file " />
		 &nbsp;&nbsp;<input type="button" class="btnSel" id="btnCancel" onClick="cancelDoc();" value="Cancel"></td></tr>
