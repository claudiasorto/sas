...
<tr><td class="backTablaForm" colspan="2">Hours Completion Report</td>
...
<tr><td class="itemForm">Employee status </td><td>
<select id="lsStatus" class="txtPag" id="lsStatus">
<option value="1">Active</option>
<option value="0">Inactive</option>
<option value="-1">[ALL]</option>
</select></td></tr>
<tr><td colspan="2" align="center"><input type="button" class="btn" value="Search" onClick="loadRepScorecard()"/></td></tr>
</table>
<br><br>
<div id="lyData"></div>