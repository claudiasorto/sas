...
<tr><td colspan="2" class="itemCenter">Select filters to generate weekly report performance</td></tr>
...
<tr><td class="itemCenter" colspan="2"><input type="button" class="btn" value="Search" onClick="loadWeeklyPerformance()"></td></tr>
</table>
<br>
<div id="lyData"></div>