...
function filtrosConsolidado(){
	$.ajax({
	type: "POST",
	url: "ajax/ajx_reportScorecard.php",
	data: "Do=filtrosConsolidado",
...
function loadConsolidado(){
	...
	type: "POST",
	url: "ajax/ajx_reportScorecard.php",
	data: "Do=loadConsolidado&cuenta="+Cuenta+"&sup="+Sup+"&emp="+Emp+"&nombre="+Nombre+"&badge="+Badge+"&fecIni="+FecIni+"&fecFin="+FecFin,
	success: function(rslt){
