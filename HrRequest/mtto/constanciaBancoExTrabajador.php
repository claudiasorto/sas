...
require_once("../PHPWord.php");
 ...
 $section->addText('Por este medio hacemos constar que ____________________, trabajó para Express Teleservices S.A. de C.V. desde el _______________ hasta el _______________, desempeñando el cargo de _________________________, y devengando un salario mensual de ____________ dólares ($______) de lo cual se hacen las siguientes retenciones:',$styleCuerpo, $styleJustif);
  $section->addText('',$styleCuerpo);
...
header("Content-Disposition: attachment; filename='constancia para banco Ex-Trabajador.docx'");
readfile($temp_file);
unlink($temp_file);
