...
require_once("../PHPWord.php");
 ...
 $section->addText('Por este medio hacemos constar que ______________________, trabajó para Express Teleservices S.A. de C.V. desde el ________________ hasta el _______________, desempeñando el cargo de _______________, y devengando un salario mensual de _______________ dólares ($__________) mas bonos, dicho salario cuenta con los debidos descuentos de ley.',$styleCuerpo, $styleJustif);
 $section->addText('',$styleCuerpo);
...
header("Content-Disposition: attachment; filename='constancia de ex-trabajador.docx'");
readfile($temp_file);
unlink($temp_file);
