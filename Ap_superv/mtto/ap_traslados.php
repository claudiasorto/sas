...
<tr><td align="right" class="txtPag">Efectivo desde:&nbsp;</td><td><input type="text" name="fecha_inicio" id="fecha_inicio" size="15" class="txtPag" readonly="1" /><img src="images/calendar.jpg" onclick="return showCalendar('fecha_inicio', '%d/%m/%Y');" style="cursor:pointer;" /></td></tr>
<tr><td align="right" class="txtPag">Cuenta destino:&nbsp;</td><td class="txtPag"><!--optcuenta--></td></tr>
<tr><td align="right" class="txtPag">Departamento destino:&nbsp; </td><td><span id="lyDepart"><!--optDepto--></span></td></tr>
...
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td colspan="2" align="center" ><input type="button" class="ui-corner-all btn" value="Aceptar" onclick="sv_traslados()" /></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
