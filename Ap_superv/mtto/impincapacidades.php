...
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td class="txtPag">N&deg; Badge de Empleado:&nbsp; </td><td class="txtPag" colspan="2"><?php echo $_GET['user']; ?></td></tr>
...
<tr><td align="right" class="txtPag">Incapacidad de:</td><td class="txtPag"> <?php echo $_GET['centro']; ?></td></tr>
