...
<tr><td class="txtPag" align="right">Días solicitados</td><td><input type="text" id="txtdias" class="txtPag" onkeydown="return onlyNumber(this,event)"></td></tr>
<tr><td align="right" class="txtPag"> Del: </td><td><input type="text" name="fecha_inicio" id="fecha_inicio" size="15" class="txtPag" readonly="1" /><img src="images/calendar.jpg" onclick="return showCalendar('fecha_inicio', '%d/%m/%Y');" style="cursor:pointer;" /></td></tr>
<tr><td align="right" class="txtPag">Fecha de Ingreso:</td><td class="txtPag"><!--ingreso--></td></tr>
...
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td colspan="2" align="center" ><input type="button" class="ui-corner-all btn" value="Aceptar" onclick="sv_vacacion()" /></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
