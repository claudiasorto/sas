...
<tr><td align="right" class="txtPag">D&iacute;as Solicitados:&nbsp;</td><td><input type="text" value="<!--dias_incap-->" id="txtDias" class="txtPag"></td></tr>
...
<tr><td></td></tr>
<tr><td colspan="4" align="center" ><input type="button" class="ui-corner-all btn" value="Actualizar" onclick="saveup_vacacion()" /></td></tr>
</table>
