...
<a href='mtto/impretiros.php?Idapxemp=<!--apxemp-->&user=<!--username-->&last=<!--last-->&first=<!--first-->&cuenta=<!--cuenta-->&depto=<!--depto-->&plaza=<!--plaza-->&fecha=<!--storage-->&nom_ap=<!--nom_ap-->&start=<!--startdate-->&observ=<!--comment-->&aprob_emp=<!--aprob_emp-->&aprob_sup=<!--aprob_superv-->&aprob_area=<!--aprob_area-->&aprob_work=<!--aprob_work-->&aprob_hr=<!--aprob_hr-->&aprob_gen=<!--aprob_gen-->' target="_blank"><img src="images/print.png" border="0" width="50" style="cursor:pointer;" title="Pulse para imprimir" align="absmiddle" /></a>
</td></tr>
<tr><th colspan="4" class="showItem"><u><!--nom_ap--></u></th></tr>
<tr><td align="right" class="txtPag">&Uacute;ltimo d&iacute;a de Trabajo:</td><td class="txtPag"><!--startdate--></td></tr>
