...
<a href='mtto/impvacaciones.php?Idapxemp=<!--apxemp-->&user=<!--username-->&last=<!--last-->&first=<!--first-->&cuenta=<!--cuenta-->&depto=<!--depto-->&plaza=<!--plaza-->&fecha=<!--storage-->&nom_ap=<!--nom_ap-->&dias=<!--dias_incap-->&start=<!--startdate-->&end=<!--enddate-->&ingreso=<!--date_admis-->&observ=<!--comment-->' target="_blank"><img src="images/print.png" border="0" width="50" style="cursor:pointer;" title="Pulse para imprimir" align="absmiddle" /></a>
</td></tr>
<tr><th colspan="4" class="showItem"><u><!--nom_ap--></u></th></tr>
<tr><td class="txtPag" align="right">Días solicitados:&nbsp;</td><td class="txtPag"><!--dias_incap--></td></tr>
...
<tr><td align="right" class="txtPag">Fecha de Ingreso:</td><td class="txtPag"><!--date_admis--></td></tr>
