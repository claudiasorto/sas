<?php
  ...
  header("Content-Disposition: attachment; filename=rpt_payroll.xls");
 ...
 $sqlText = "select distinct(e.employee_id), e.username, e.firstname, e.lastname from employees e ".$_POST['filtro']." order by firstname";
 ...
 if($dbEx->numrows>0){
 ?>
 <tr class="txtForm"><td width="5%">N&deg;</td><td width="8%">BADGE</td><td width="30%">EMPLOYEE</td><td width="10%">DAYTIME HOURS</td><td width="10%">NOCTURNAL HOURS</td><td width="10%">AP HOURS</td><td width="10%">VACATIONS</td><td width="10%">EXCEPTION HOURS</td><td width="10%">ADDITIONAL HOURS</td><td>PAID HOLIDAY</td><td>DAY OVERTIME</td><td>NIGTH OVERTIME</td><td>HOLIDAY OVERTIME</td><td width="10%">TOTAL HOURS</td></tr>
 <?php 
 	$n = 1;
 	foreach($dt as $dtE){
